            ...
            <%--$("#but_sub").click(function () {--%>
				...
				<%--&lt;%&ndash;if(flag){&ndash;%&gt;--%>
                    <%--&lt;%&ndash;$.ajax({&ndash;%&gt;--%>
                        ...
                        <%--&lt;%&ndash;url:"${ctx}/sys/propertyInfo/savePropInfo",&ndash;%&gt;--%>
                        <%--&lt;%&ndash;data:$('#inputForm2').serialize(),&ndash;%&gt;--%>
                        <%--&lt;%&ndash;success:function (data) {&ndash;%&gt;--%>
                            <%--&lt;%&ndash;if(data=='ok'){&ndash;%&gt;--%>
                <%----%>
                                <%--&lt;%&ndash;$('#myModal').modal('hide');&ndash;%&gt;--%>
                                <%--&lt;%&ndash;$("#myModal").on("hidden.bs.modal", function (e) {&ndash;%&gt;--%>
                                    <%--&lt;%&ndash;alert("保存成功！");&ndash;%&gt;--%>
                                    <%--&lt;%&ndash;window.location.href="${ctx}/biz/category/bizCategoryInfo/form?id="+id;&ndash;%&gt;--%>
                                <%--&lt;%&ndash;});&ndash;%&gt;--%>
                            <%--&lt;%&ndash;}&ndash;%&gt;--%>
                        <%--&lt;%&ndash;}&ndash;%&gt;--%>
                    <%--&lt;%&ndash;});&ndash;%&gt;--%>
...
<body>
				...
				<%--<div class="controls">--%>
					...
					<%--<c:forEach items="${bizCategoryInfo.propertyInfoList}" var="propertyInfo">--%>
						<%--<div  style="width: 100%;display: inline-block">--%>
							<%--&lt;%&ndash;<input  class="select_all" id="${propertyInfo.id}" type="checkbox" name="catePropertyInfos" value="${propertyInfo.id}"/> &ndash;%&gt;--%>
		...
		<%--<div class="modal-dialog">--%>
			<%--<div class="modal-content">--%>
				<%--<div class="modal-header">--%>
					...
					<%--</h4>--%>
				<%--</div>--%>
				<%--&lt;%&ndash;@elvariable id="propertyInfo" type="com.wanhutong.backend.modules.sys.entity.PropertyInfo"&ndash;%&gt;--%>
	...
	<%--<script type="text/javascript">--%>
        <%--$(document).ready(function() {--%>
            ...
            <%--&lt;%&ndash;window.prettyPrint && prettyPrint();&ndash;%&gt;--%>
