...
<form:form id="inputForm" modelAttribute="bizPoHeader" action="${ctx}/biz/po/bizPoHeader/save?prewStatus=prew"
    ...
    <table id="contentTable" class="table table-striped table-bordered table-condensed">
        ...
        <tbody>
        <c:forEach items="${bizPoPaymentOrder.page.list}" var="bizPoPaymentOrder">
            <tr>
                <td>
                ...
                <td>
                    ...
                    <shiro:hasPermission name="biz:po:sure:bizPoPaymentOrder">
                        <c:if test="${fromPage == 'requestHeader' && bizPoPaymentOrder.total == '0.00'}">
                            <a href="${ctx}/biz/po/bizPoPaymentOrder/form?id=${bizPoPaymentOrder.id}&poHeaderId=${bizPoHeader.id}&fromPage=${fromPage}">确认aaa支付金额</a>
                        </c:if>
                    </shiro:hasPermission>
