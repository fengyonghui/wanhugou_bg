...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/biz/order/bizPurchaserVendor/">经销店供应商关联关系列表</a></li>
		<shiro:hasPermission name="biz:order:bizPurchaserVendor:edit"><li><a href="${ctx}/biz/order/bizPurchaserVendor/form">经销店供应商关联关系添加</a></li></shiro:hasPermission>
	</ul>
		...
		<c:forEach items="${page.list}" var="bizPurchaserVendor">
			<tr>
				...
				<shiro:hasPermission name="biz:order:bizPurchaserVendor:edit"><td>
					...
					<a href="${ctx}/biz/order/bizPurchaserVendor/delete?id=${bizPurchaserVendor.id}" onclick="return confirmx('确认要删除该经销店供应商关联关系吗？', this.href)">删除</a>
