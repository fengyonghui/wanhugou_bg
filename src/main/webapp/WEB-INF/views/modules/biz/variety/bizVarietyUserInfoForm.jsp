...
<body>
	...
	<form:form id="inputForm" modelAttribute="bizVarietyUserInfo" action="${ctx}/biz/variety/bizVarietyUserInfo/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label">类别 biz_variety_info：</label>
			<div class="controls">
				<form:input path="varietyId" htmlEscape="false" maxlength="11" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">用户 sys_user：</label>
			<div class="controls">
