...
<input id="showChart" onclick="$Url.go2Url('${adminPath}/biz/statistics/between/product')" class="btn btn-primary" type="button" value="查看图表"/>
...
<script type="application/javascript">
    function initChart() {
        ...
        $.ajax({
            ...
            data: {"endDate": endDate,"startDate": startDate, "variId" : variId, "dataType" : dataType, "purchasingId" : purchasingId},
            dataType: "json",
