...
<script type="application/javascript">
    function initChart() {
        ...
        $.ajax({
            type: 'GET',
            url: "${adminPath}/biz/statistics/singleUserProfitData",
                    ...
                    toolbox: {
                        ...
                        feature: {
                            ...
                            myShowTable: {
                                ...
                                onclick: function (){
                                    window.location.href="${adminPath}/biz/statistics/singleUserProfitDataTable?month=" + startDate;
                                }
                            }
                        }
                    },
    ...
    function exportTable() {
        ...
        myform.attr('action',"${adminPath}/biz/statistics/singleUserProfitDataDownload");
