...
<div>
    <input id="showChart" onclick="$Url.go2Url('${adminPath}/biz/statistics/user')" class="btn btn-primary" type="button" value="查看图表"/>
...
<script type="application/javascript">
    function initData() {
        ...
        window.location.href="${adminPath}/biz/statistics/customTable?month=" + date;
    }
</script>
</body>
</html>