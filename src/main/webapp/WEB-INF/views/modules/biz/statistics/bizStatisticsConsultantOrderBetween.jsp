...
<script type="application/javascript">
    function initChart() {
        ...
        $.ajax({
            ...
            data: {"startDate": startDate,"endDate": endDate, "purchasingId" : purchasingId},
            dataType: "json",
                    ...
                    toolbox: {
                        ...
                        feature: {
                            ...
                            myShowTable: {
                                ...
                                onclick: function (){
                                    window.location.href="${adminPath}/biz/statistics/between/consultantOrderAnalysisTables?startDate=" + startDate + "&endDate=" + endDate + "&purchasingId=" + purchasingId;
                                }
                            }
                        }
                    },
    ...
    function exportTable() {
        ...
        myform.attr('action',"${adminPath}/biz/statistics/between/consultantOrderDataDownload");
