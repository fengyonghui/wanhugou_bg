...
<script type="application/javascript">
    function initChart() {
        ...
        $.ajax({
            ...
            data: {"startDate": startDate,"endDate": endDate, "variId" : consultantId},
            dataType: "json",
                    ...
                    toolbox: {
                        ...
                        feature: {
                            ...
                            myShowTable: {
                                ...
                                onclick: function (){
                                    window.location.href="${adminPath}/biz/statistics/between/customOrderAnalysisTables?startDate=" + startDate + "&endDate=" + endDate + "&consultantId=" + consultantId;
                                }
                            }
                        }
                    },
    ...
    function exportTable() {
        ...
        myform.attr('action',"${adminPath}/biz/statistics/between/customOrderDataDownload");
        ...
        var myConsultantId = $("<input type='hidden' name='consultantId' />");
        myConsultantId.attr('value', consultantId);

        myform.append(myStartDate);
        myform.append(myEndDate);
        myform.append(myUpdateReason);
        myform.append(myConsultantId);
