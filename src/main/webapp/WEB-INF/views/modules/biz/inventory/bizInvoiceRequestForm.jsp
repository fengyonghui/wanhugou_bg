                    ...
                    success:function (data) {
                        ...
                        $.each(data, function (index,requestHeader) {
                            ...
                            $.each(requestHeader.requestDetailList,function (index,detail) {
                                ...
                                tr_tds+= "<td>"+detail.skuInfo.name+"</td><td>"+detail.skuInfo.vendorName+"</td><td>"+(detail.skuInfo.itemNo==undefined?"":detail.skuInfo.itemNo)+"</td><td>"+detail.skuInfo.partNo+"</td><td>"+(detail.skuInfo.skuPropertyInfos == undefined ? "" : detail.skuInfo.skuPropertyInfos) +"</td>" ;
