...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/biz/sku/bizCustSku/">经销店商品价格列表</a></li>
		<shiro:hasPermission name="biz:sku:bizCustSku:edit"><li><a href="${ctx}/biz/sku/bizCustSku/form">经销店商品价格添加</a></li></shiro:hasPermission>
	</ul>
		...
		<c:forEach items="${page.list}" var="bizCustSku">
			<tr>
				...
				<shiro:hasPermission name="biz:sku:bizCustSku:edit"><td>
					...
					<a href="${ctx}/biz/sku/bizCustSku/delete?id=${bizCustSku.id}" onclick="return confirmx('确认要删除该经销店商品价格吗？', this.href)">删除</a>
