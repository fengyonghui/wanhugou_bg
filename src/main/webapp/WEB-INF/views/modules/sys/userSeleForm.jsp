	...
	<div class="control-group">
		...
		<div class="controls">
			<sys:treeselect id="company" name="company.id" value="${user.company.id}" labelName="company.name" labelValue="${user.company.name}"
							title="公司" url="/sys/office/queryTreeSele?type=8,9,10,11&source=officeConnIndex" cssClass="required"/>
		</div>
	</div>
	<div class="control-group">
		...
		<div class="controls">
			<sys:treeselect id="office" name="office.id" value="${user.office.id}" labelName="office.name" labelValue="${user.office.name}"
							title="部门" url="/sys/office/queryTreeSele?type=8,9,10,11&source=officeConnIndex" cssClass="required" notAllowSelectParent="true"/>
		</div>
	</div>
	<div class="control-group">
