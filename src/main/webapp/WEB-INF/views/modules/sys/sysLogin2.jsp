...
<body>
	...
	<div class="footer">
		Copyright &copy; 2012-${fns:getConfig('copyrightYear')} <a href="${pageContext.request.contextPath}${fns:getFrontPath()}">${productName}</a> - Powered By <a href="http://www.wanhutong.com" target="_blank">JeeSite</a> ${fns:getConfig('version')}
	</div>
