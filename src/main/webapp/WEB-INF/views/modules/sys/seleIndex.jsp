...
<div id="content" class="row-fluid">
	...
	<div id="right">
		<iframe id="officeContent" src="${ctx}/sys/user/list?company.type=8&company.customerTypeTen=10&company.customerTypeEleven=11&conn=selectIndex" width="100%" height="91%" frameborder="0"></iframe>
	</div>
</div>
		...
		var setting = {data:{simpleData:{enable:true,idKey:"id",pIdKey:"pId",rootPId:'0'}},
			callback:{onClick:function(event, treeId, treeNode){
					...
					$('#officeContent').attr("src","${ctx}/sys/user/list?company.id="+id+"&company.name="+treeNode.name+
												...
												+"&office.id="+id+"&office.name="+treeNode.name+"&conn=selectIndex");
				}
			}
		};
