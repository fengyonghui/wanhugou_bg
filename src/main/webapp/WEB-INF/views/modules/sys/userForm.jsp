...
<body>
	...
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/user/save" method="post" class="form-horizontal">
		...
		<form:hidden id="company.searchCompanyId" path="company.searchCompanyId" value="${searchCompanyId}"/>
		<form:hidden id="company.searchCompanyName" path="company.searchCompanyName" value="${searchCompanyName}"/>
		<form:hidden id="office.searchOfficeId" path="office.searchOfficeId" value="${searchOfficeId}"/>
		<form:hidden id="office.searchOfficeName" path="office.searchOfficeName" value="${searchOfficeName}"/>
