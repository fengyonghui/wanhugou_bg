...
<body>
	...
	<div id="content" class="row-fluid">
		...
		<div id="right">
			<iframe id="officeContent" src="${ctx}/sys/office/supplierListGys?id=12" width="100%" height="91%" frameborder="0"></iframe>
		</div>
	</div>
	<script type="text/javascript">
		...
		function refreshTree(){
			$.getJSON("${ctx}/sys/office/supplierTreeData",function(data){
