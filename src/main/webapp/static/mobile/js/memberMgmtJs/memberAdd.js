	...
	ACCOUNT.prototype = {
        ...
        saveDetail: function () {
            ...
            mui('.inSaveBtn').on('tap','#inSaveBtn',function(){
                ...
                var membRemarkVal = $("#membRemark").val(); //备注
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    data: {"id":"", "fromOffice.id": _this.fromOfficeId, "recvEta":inPoLastDaVal, "remark": membRemarkVal, "bizStatus": bizStatusVal, "skuInfoIds": _this.skuInfoIds, "reqQtys": _this.reqQtys, "reqDetailIds":_this.reqDetailIds, "LineNos":_this.LineNos},
        ...
        searchSkuHtml: function() {
            var _this = this;
            mui('#inAmendPoLastDaDiv').on('tap','#mainHeadBtn',function(){
...
//                            var prodOfficeName= prodKeys[5];
                            ...
                            $.each(skuInfoList,function (index,skuInfo) {
                                ...
                                resultListHtml += '<div class="mui-row app_bline2" id="serskudiv_' + skuInfo.id + '">' +
