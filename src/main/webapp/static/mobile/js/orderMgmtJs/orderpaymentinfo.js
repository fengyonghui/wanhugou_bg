		        ...
		        mui("#refreshContainer").pullRefresh({
			        ...
			        down : {
			            ...
			            callback :function(){ 
							...
							if(_this.userInfo.invStatus==undefined){
								_this.userInfo.invStatus="";
							}
							...
							if(_this.userInfo.waitPay==undefined){
								_this.userInfo.waitPay="";
							}
							if(_this.userInfo.applyPayment==undefined){
								_this.userInfo.applyPayment="";
							}
			                ...
			                if(_this.userInfo.isFunc){
		                    	...
		                    	pager['size']= 20;
		                    	pager['pageNo'] = 1;
		                    	pager['num'] = _this.userInfo.num;//备货单号
		                    	pager['vendOffice.id'] = _this.userInfo.vendOffice;//供应商
		                    	pager['invStatus'] = _this.userInfo.invStatus;//发票状态
		                    	pager['bizStatus'] = _this.userInfo.bizStatus;//业务状态
		                    	pager['processTypeStr'] = nameTxt;//审核状态
		                    	pager['poSchType'] = _this.userInfo.poSchType;//排产状态
		                    	pager['waitPay'] = _this.userInfo.waitPay;//待支付
		                    	pager['applyPayment'] = _this.userInfo.applyPayment;//可申请付款
