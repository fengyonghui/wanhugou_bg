...
//		        mui.ajax("/a/biz/request/bizRequestHeader/list4Mobile?page2='+page+'&size='+size",{
//		            data: {
//						pageNo: params
//					},
//		            dataType:'json',
...
//			            var returnData = data.ticketNoItems;
//			            var element=document.getElementById("list");
//			            var para;
//			         　　　         var node;
//			            for(var i = 0; i<returnData.length;i++){
//			                para = document.createElement("li");
//			                node = document.createTextNode(returnData[i].psrName)
...
//		                data.ext/pager.size;
//		                console.log('222333')
//			            console.log(data.ext/pager.size)
