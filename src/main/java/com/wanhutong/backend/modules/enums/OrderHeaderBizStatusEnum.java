...
public enum OrderHeaderBizStatusEnum {
 ...
 //   地址管理里的默认地址类型  业务状态 0未支付； 5首付款支付 6线下支付 10全部支付 15同意发货(供货中) 17采购中 18采购完成 19 供应中心供货 20已发货 25客户已收货 30已完成35已取消40已删除45审核失败
    ORDER_DEFAULTSTATUS(1),UNPAY(0),INITIAL_PAY(5),LINE_PAY(6),ALL_PAY(10),SUPPLYING(15),APPROVE(16),PURCHASING(17),ACCOMPLISH_PURCHASE(18),
