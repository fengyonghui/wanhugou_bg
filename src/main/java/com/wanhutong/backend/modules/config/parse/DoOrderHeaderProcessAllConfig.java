 ...
 * @author ma.qiang
 */
@XStreamAlias("DoOrderHeaderProcessAllConfig")
public class DoOrderHeaderProcessAllConfig extends ConfigGeneral {

    private static final Logger LOGGER = LoggerFactory.getLogger(DoOrderHeaderProcessAllConfig.class);
    ...
    @Override
    public DoOrderHeaderProcessAllConfig parse(String content) throws Exception {
        DoOrderHeaderProcessAllConfig purchaseOrderProcessConfig = XmlUtils.fromXml(content);
