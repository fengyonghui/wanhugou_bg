 ...
 * @author wangby
 */
@XStreamAlias("PurchaseOrderProcessForOrderHeaderConfig")
public class PurchaseOrderProcessForOrderHeaderConfig extends ConfigGeneral {

    private static final Logger LOGGER = LoggerFactory.getLogger(PurchaseOrderProcessForOrderHeaderConfig.class);
    ...
    @Override
    public PurchaseOrderProcessForOrderHeaderConfig parse(String content) throws Exception {
        PurchaseOrderProcessForOrderHeaderConfig purchaseOrderProcessConfig = XmlUtils.fromXml(content);
