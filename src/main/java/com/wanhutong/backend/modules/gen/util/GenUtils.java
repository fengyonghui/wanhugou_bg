	...
	public static void initColumnField(GenTable genTable){
		for (GenTableColumn column : genTable.getColumnList()){
			...
			if (!StringUtils.equalsIgnoreCase(column.getName(), "id")
					&& !StringUtils.equalsIgnoreCase(column.getName(), "create_id")
			...
			// 创建者、更新者
			else if (StringUtils.startsWithIgnoreCase(column.getName(), "create_id")
					|| StringUtils.startsWithIgnoreCase(column.getName(), "update_id")){
				column.setJavaType(User.class.getName());
