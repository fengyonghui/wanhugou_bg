 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/biz/product/bizProductInfoV3")
public class BizProductInfoV3Controller extends BaseController {

    @Autowired
    private BizProductInfoV3Service bizProductInfoService;
    @Autowired
    ...
    public BizProductInfo get(@RequestParam(required = false) Integer id) {
        ...
        if (id != null) {
            ...
            skuInfosList.forEach(o -> {
                ...
                attributeValueV2.setObjectName(BizProductInfoV3Service.SKU_TABLE);
...
//        }
        ...
        return "modules/biz/product/bizProductInfoFormV3";
    }
    ...
    public String copy(BizProductInfo bizProductInfo, Model model) {
        ...
        model.addAttribute("varietyInfoList", varietyInfoList);
        model.addAttribute("skuTypeLit", skuTypeLit);
        return "modules/biz/product/bizProductInfoCopyFormV3";
    }
