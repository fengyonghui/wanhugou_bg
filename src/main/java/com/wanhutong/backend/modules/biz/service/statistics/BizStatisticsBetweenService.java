...
public class BizStatisticsBetweenService {
     ...
     */
    public List<BizProductStatisticsDto> productStatisticData (String startDate, String endDate, Integer variId, Integer purchasingId, Integer type) {
        return bizOrderHeaderDao.getProductStatisticDataBetween(startDate, endDate + " 23:59:59", variId, purchasingId, type);
    }
     ...
     * @return 根据不同产品分类的统计数据
     */
    public List<BizProductStatisticsDto> skuTendencyData (String startDate, String endDate, Integer variId, Integer purchasingId, Integer type, String timeType, String itemNo) {
        return bizOrderHeaderDao.skuTendencyDataBetween(startDate, endDate + " 23:59:59", variId, purchasingId, type, timeType, itemNo);
    }
